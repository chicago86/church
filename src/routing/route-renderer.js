...
import { ErrorBoundaryWithRetry } from "../components/error-boundary-with-retry";
import "./route-renderer.css";
...
export default function RouterRenderer() {
  ...
  // const [isPending] = useTransition(SUSPENSE_CONFIG);
  const [isPending, startTransition] = useTransition(SUSPENSE_CONFIG);
  ...
  return (
    <ErrorBoundaryWithRetry>
      {/* <Suspense fallback="Loading - suspense fallback..."> */}
        ...
        {isPending ? (
          <div className="RouteRenderer-pending">Loading - transition pending...</div>
        ) : null}
        {routeComponent}
      {/* </Suspense> */}
    </ErrorBoundaryWithRetry>
